...
print_summary() {
    ...
    if [[ -n "$IPTV_SERVER" ]]; then
        echo -e "${BLUE}🔧 IPTV Konfiguration:${NC}"
        echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
        echo -e "   In den Admin-Einstellungen können Sie Ihre ${GREEN}echten${NC} IPTV-Daten eingeben:"
        echo ""
        echo -e "   ${GREEN}Server URL:${NC} http://$IPTV_SERVER ${BLUE}(oder Ihre IPTV-Server-URL)${NC}"
        echo -e "   ${GREEN}Port:${NC}       80 ${BLUE}(oder Ihr Port)${NC}"
        echo -e "   ${GREEN}Access Code:${NC} Ihr XuiOne Access Code"
        echo -e "   ${GREEN}API-KEY:${NC}    Ihr XuiOne API Key"
        echo ""
        echo -e "   ${BLUE}✨ AUTOMATISCHER PROXY:${NC}"
        echo -e "   Die App erkennt automatisch, dass Sie HTTPS verwenden und"
        echo -e "   leitet HTTP-Anfragen über den Nginx-Proxy (/api/) weiter."
        echo -e "   ${GREEN}→ Keine Mixed Content Fehler!${NC}"
        echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
        echo ""
    fi
}
